...
const Muscles = () => {
  ...
  return (
    <>
      ...
      <div className="bg-[#101820] flex flex-col items-center w-full rounded-xl">
        
            <div className="bg-[#101820] w-[15%] m-5 mt-24 rounded-xl">
      ...
      >
        ...
        <div className="py-4 overflow-y-auto">
          <div className="py-4 text-gray-500 whitespace-normal dark:text-gray-400">
            <p>Press Banca Inclinada</p>
            <p>Press Banca</p>
            <p>Press Banca Inclinada (mancuerna)</p>
            <p>Press Banca (mancuerna)</p>
            <p>Aperturas de pecho</p>
            <p>Cruces de polea</p>
            <p>Press Banca</p>
          </div>
          {/* Agregar cuadro de entrada de kilogramos */}
          <div className="py-4">
            <label htmlFor="kilograms" className="text-gray-500 dark:text-gray-400">
              Kilogramos:
            </label>
            <input
              type="text"
